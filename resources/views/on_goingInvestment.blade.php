...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>On going-Investment <small>Table</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-plus-square-o"></i></a>
                        <ul class="dropdown-menu" role="menu">
                          <li><a data-toggle="modal" data-target=".bs-example-modal-sm" href="#">Add Investment</a>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                     The List of Your On going Investment, Always Chech your Pay-To table to Know when you're matched to make payment because failure to make payment on time attract some penalties
                    </p>
